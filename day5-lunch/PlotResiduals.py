...
# print(minimum) this = -76.44
# print(maximum) this = 6501

fig,ax = plt.subplots()
ax.set_title("Plot of linear regression residuals")
hist = ax.hist(results.resid, bins=400, range=[-200,200])
ax.set_xlabel("Residual values")
ax.set_ylabel("Counts")
fig.savefig("residualPlot.png")
plt.close()